...
#
# Program Name : jetstream_container_refresh.ps1
...
#
# Interactive Usage: 
# ./jetstream_container_refresh.ps1
#
# Non-Interactive Usage:
# ./jetstream_container_refresh.ps1 [template_name] [container_name]
# ./jetstream_container_refresh.ps1 tpl cdc
#
#########################################################
#                   DELPHIX CORP                        #

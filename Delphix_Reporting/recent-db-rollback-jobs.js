...
var RESULT_COL = 'result_recent_db_rollback_jobs';

var dependencies = [ 'Job' ];

var limit = dx.defineTunableInt({
    _id : 'recent-db-rollback-jobs.limit',
    defaultValue : 2000,
    description : 'Maximum number of DB_ROLLBACK jobs to display',
    report : RESULT_COL
});

dx.updateMetadata(RESULT_COL, {
    name : 'Recent DB_ROLLBACK Jobs',
    type: dx.report.type.TABLE,
    category : dx.report.category.ACTIVITY,
    script : 'recent-db-rollback-jobs.js',

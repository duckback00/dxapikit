...
var RESULT_COL = 'result_recent_db_refresh_jobs';

var dependencies = [ 'Job' ];

var limit = dx.defineTunableInt({
    _id : 'recent-db-refresh-jobs.limit',
    defaultValue : 2000,
    description : 'Maximum number of DB_REFRESH jobs to display',
    report : RESULT_COL
});

dx.updateMetadata(RESULT_COL, {
    name : 'Recent DB_REFRESH Jobs',
    type: dx.report.type.TABLE,
    category : dx.report.category.ACTIVITY,
    script : 'recent-db-refresh-jobs.js',

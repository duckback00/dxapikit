...
#      use ./specification_objects.sh if necessary to create objects array
#
# Usage: ./specification.sh
#
#########################################################
...
then
   ...
   #
   # To build objects array, use ./specification_objects.sh script ...
   #
   TARGET_HOST="${DMIP}"
   GLOBIGNORE="*"
   json="{

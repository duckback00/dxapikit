...
#
# Program Name : vdb_rollback_timestamp.sh
# Description  : Delphix API Rollback VDB by Timeflow Timestamp
...
echo "Enter Timestamp between Start and End Point values (exclude quotes): "
read TZ
if [ "${TZ}" == "" ]
then

...
#
# Program Name : vdb_refresh_timestamp.sh
# Description  : Delphix API Refresh VDB by Timeflow Timestamp
...
#
# Interactive Usage: ./vdb_refresh_timestamp.sh
#
...
echo "Enter Refresh Timestamp between Start and End Point values (exclude quotes): "
read TZ
if [ "${TZ}" == "" ]
then
